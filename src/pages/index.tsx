  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Hi, I'm Robert-Jan and on my blog, I share with you my thoughts and ramblings about technologies like, C#, .NET and Azure."
        />
        <meta property="og:title" content="Robert-Jan.dev" />
        <meta
          property="og:description"
          content="Hi, I'm Robert-Jan and on my blog, I share with you my thoughts and ramblings about technologies like, C#, .NET and Azure."
        />
        <meta property="og:url" content="https://robert-jan.dev" />
      </Head>
      <div className="mx-auto px-4 pt-6 sm:px-8 sm:pt-12 lg:px-20">
        <div className="w-full lg:w-2/3">
          <svg xmlns="http://www.w3.org/2000/svg" width="0" height="0">
            <defs>
              <linearGradient id="gradient" x1="80.86%" x2="19.14%" y1="0%" y2="100%">
                ...
                <stop offset="100%" stopColor="#EA4798" />
              </linearGradient>
            </defs>
          </svg>
          ...
          <p className="pt-3 text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
            Hi, I&apos;m Robert-Jan and on this blog, I share with you my thoughts and ramblings
            about technologies like, C#, .NET and Azure. I learn so much when using those tools on a
            daily basis that I want to share my knowledge with you trough this blog.
          </p>
