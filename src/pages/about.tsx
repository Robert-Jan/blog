...
export default function About(): JSX.Element {
  return (
    <>
      ...
      <div className="mx-auto flex pt-12 lg:px-20">
        ...
        <div className="w-2/5">
          ...
          <div className="rounded-2xl border border-zinc-100 mt-6 p-6 dark:border-zinc-700/40">
            ...
            <ol className="mt-6 space-y-4">
              <li className="flex gap-4">
                ...
                <dl className="flex flex-auto flex-wrap gap-x-2">
                  ...
                  <dd className="text-xs text-zinc-500 dark:text-zinc-400">AZ-900</dd>
                  <dd
              ...
              <li className="flex gap-4">
                ...
                <dl className="flex flex-auto flex-wrap gap-x-2">
                  ...
                  <dd className="text-xs text-zinc-500 dark:text-zinc-400">AZ-220</dd>
                  <dd
                    className="ml-auto text-xs text-zinc-400 dark:text-zinc-500">
                    <time dateTime="2023">2023</time>
