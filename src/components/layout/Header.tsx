...
export const Header = () => (
  <header className="pointer-events-none bg-zinc-100 dark:bg-slate-800">
    <div className="mx-auto flex max-w-5xl gap-4 pt-6 pb-12">
      ...
      <nav className="pointer-events-auto block">
        <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-slate-800 shadow-lg shadow-slate-800/5 ring-1 ring-slate-900/5 backdrop-blur dark:bg-slate-900/90 dark:text-slate-200 dark:ring-white/10">
          {menu.map((item) => (
            <li key={item.url}>
              <Link
